...
class CheckoutViewTests(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        url = reverse('checkout') + '?count=1&total_amount=1000&booking_option=economy'
    ...
    def test_discount_applied_for_active_subscription(self):
        ...
        response = self.client.get(reverse('checkout') + '?count=1&total_amount=1000&booking_option=economy')
